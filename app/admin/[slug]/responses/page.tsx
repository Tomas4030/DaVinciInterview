...
export default function AdminCompanyResponsesPage({ params }: Props) {
  return (
    <section className="space-y-5">
      ...
      <div className="rounded-xl border border-[var(--c-border)]/70 bg-[var(--c-surface)] p-5">
        <p className="text-sm text-[var(--c-muted)]">
          Placeholder da Fase 4.4 para listagem por vaga/candidato/status e detalhe de sessao.
        </p>

        <div className="mt-4 flex flex-wrap gap-2">
          <Link href="/admin/respostas" className="btn-primary inline-flex px-4 py-2">
            Ver respostas legadas
          </Link>
          <Link
