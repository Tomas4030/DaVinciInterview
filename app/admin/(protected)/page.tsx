      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {[
          ...
          },
          {
            ...
            value:
              vagas.length > 0
                ? `${Math.round(totalRespostas / vagas.length)}`
                : "—",
          ...
          <div className="divide-y divide-gray-50">
            {vagas.map((vaga) => (
              ...
              >
                ...
                {/* Modalidade */}
                <span
                  className={`tag hidden sm:inline-flex ${MODALIDADE_STYLE[vaga.modalidade] ?? "bg-gray-50 text-gray-500"}`}
                >
                  {vaga.modalidade}
                </span>
                ...
                <span className="text-sm text-gray-400 tabular-nums hidden md:block w-24 text-right">
                  {vaga.total_perguntas} pergunta
                  {vaga.total_perguntas !== 1 ? "s" : ""}
                </span>
